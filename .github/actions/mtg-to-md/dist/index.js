...
var require_lib = __commonJS({
  "node_modules/iconv-lite/lib/index.js"(exports, module2) {
    ...
    iconv.enableStreamingAPI = function enableStreamingAPI(stream_module2) {
      ...
      iconv.encodeStream = function encodeStream2(encoding, options) {
...
async function main() {
  const inFile = await (0, import_promises.open)("mtg-rules/Comprehensive Rules 20221007.txt");
  const stream = inFile.createReadStream().pipe((0, import_iconv_lite.decodeStream)("win1251"));
